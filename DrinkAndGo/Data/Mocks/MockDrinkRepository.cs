        ...
        public IEnumerable<Drink> Drinks
        {
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        Name = "Beer",
                        Price = 7.95, ShortDescription = "The most widely consumed alcohol",
                    ...
                    new Drink {
                        Name = "Rum & Coke",
                        Price = 12.95, ShortDescription = "Cocktail made of cola, lime and rum.",
                    ...
                    new Drink {
                        Name = "Tequila",
                        Price = 12.95, ShortDescription = "Beverage made from the blue agave plant.",
